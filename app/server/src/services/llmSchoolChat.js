...
const LANG_INSTRUCTION = {
  en: 'You MUST reply in English only. Do not use Russian or Kazakh in your reply.',
  kk: 'Жауапты тек қазақ тілінде жаз. Орыс немесе ағылшын тілін пайдаланба.',
  ru: 'Отвечай ТОЛЬКО на русском языке. Не используй английский или казахский.',
};

const buildMessages = (message, schools, locale = 'ru') => [
  {
    role: 'system',
    content: `You are a helpful school assistant for Kazakhstan. Use ONLY the provided school data. Do not invent schools or information not in the data. ${LANG_INSTRUCTION[locale] || LANG_INSTRUCTION.ru}`,
  },
  {
    role: 'user',
    content: [
...
const chatWithSchools = async (config, message, schools, locale = 'ru') => {
