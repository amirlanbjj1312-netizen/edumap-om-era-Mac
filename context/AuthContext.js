...
const toSupabaseAccount = (user) => {
  ...
  return {
    ...
    contactPhone: metadata.contactPhone || metadata.contact_phone || '',
    organization: metadata.organization || '',
    bin: metadata.bin || '',
    iin: metadata.iin || '',
    licenseNumber: metadata.licenseNumber || '',
    licenseIssuedAt: metadata.licenseIssuedAt || '',
    licenseExpiresAt: metadata.licenseExpiresAt || '',
  ...
  const updateAccount = async (updates) => {
    if (account?.provider === 'supabase') {
      const nextMetadata = {
        ...
        contactPhone: updates.contactPhone ?? account.contactPhone ?? '',
        organization: updates.organization ?? account.organization ?? '',
        bin: updates.bin ?? account.bin ?? '',
        iin: updates.iin ?? account.iin ?? '',
        licenseNumber: updates.licenseNumber ?? account.licenseNumber ?? '',
        licenseIssuedAt: updates.licenseIssuedAt ?? account.licenseIssuedAt ?? '',
        licenseExpiresAt: updates.licenseExpiresAt ?? account.licenseExpiresAt ?? '',
        website: updates.website ?? account.website ?? '',
